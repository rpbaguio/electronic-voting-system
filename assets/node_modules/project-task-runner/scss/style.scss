...
#signin {
    ...
    @include box-shadow(0, 0, 10px, rgba(0, 0, 0, .10));
    ...
    form {
        ...
        button {
            ...
            &:hover {
                &:after {
                    @include animation(slide 1s infinite linear);
                }
            }
...
* Source: http://codepen.io/JulienMelissas/pen/LEBGLj?editors=1000
*/
.navbar-toggle {
    border: none;
        ...
        .panel-body {
            ...
            form {
                ...
                .btn-warning {
                    ...
                    border: 0;
                    padding: 10px 20px;
                    @include transition(padding, 0.15s, ease-in, 0.15s);

                    &:hover {
                        outline: 0;
                        padding: 10px 30px;
                        @include transition(padding, 0.5s, ease-out, 0.5s);
                    }
                }
            ...
            .button-group {
                ...
                p {
                    ...
                    & + hr {
                        border-top: 1px solid darken($gray-bg, 10%);
                        height: 1px;
                        margin: -20px 0 20px;
                    }
                }
                    ...
                    tr {
                        td {
                            ...
                            .btn-danger-custom {
                                ...
                                vertical-align: middle;
                                background-color: lighten($brand-danger, 35%);
                                border: 1px solid lighten($brand-danger, 15%);
                                color: $brand-danger;
                            ...
                            .btn-success-custom {
                                ...
                                vertical-align: middle;
                                background-color: lighten($brand-success, 35%);
                                border: 1px solid lighten($brand-success, 15%);
                                color: $brand-success;
...
.btn-rounded-corner {
    ...
    @include border-bottom-radius(24px);
...
.modal {
    ...
    .modal-content {
        ...
        .modal-header {
            background-color: darken($brand-primary, 15%);
            color: #fff;
            @include text-shadow(0, 0, 1px, darken($brand-primary, 10%));
            padding: 10px 15px;
            border-bottom: none;
...
.box-shadow-effect::before {
    ...
    @include box-shadow(0, 15px, 10px, #999);
...
.xdsoft_datetimepicker {
  border: 1px solid lighten($brand-primary, 15%) !important;
}
...
#db-config {
    background-color: #fff;
    margin-top: ($default-margin * 2) + 5px;
    margin-bottom: $default-margin;
    @include box-shadow(0, 0, 10px, rgba(0, 0, 0, .10));
